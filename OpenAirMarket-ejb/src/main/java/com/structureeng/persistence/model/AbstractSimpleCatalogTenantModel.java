...
/**
 * Specifies the behavior of all {@code AbstractSimpleCatalogModel} that requires to be 
 * {@code Tenant} aware.
 *
...
public abstract class 
        AbstractSimpleCatalogTenantModel<T extends Serializable, RID extends Serializable> extends 
            AbstractSimpleCatalogModel<T, RID> implements TenantModel<T> {
}
