...
public enum ProductType {
    ...
    /**
     * This product type is used to identify such provisions as professional services, 
     * transportation, telephony, and other items which do not correspond with material goods.
     */
    SERVICE, 
    
    /**
     * Resource type can be used to configure resources such as Financial, Legal or Natural 
